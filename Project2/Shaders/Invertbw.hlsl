...
P2F main(V2P pixel)
{
    ...
    float local6 = distance(float4(local4.r, local4.g, local4.b, 0), float4(float4(0.500000f,0.500000f,0.500000f,1.000000f).rgb.r, float4(0.500000f,0.500000f,0.500000f,1.000000f).rgb.g, float4(0.500000f,0.500000f,0.500000f,1.000000f).rgb.b, 0));
    result.fragment = CombineRGBWithAlpha(local6, Texture1.Sample(TexSampler, pixel.uv).a);
    // END GENERATED CODE
