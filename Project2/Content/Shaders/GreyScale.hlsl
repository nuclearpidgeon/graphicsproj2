...
P2F main(V2P pixel)
{
    ...
    float3 local5 = Desaturate(local4, float3(0.300000f,0.590000f,0.110000f), 1.000000f);
    result.fragment = CombineRGBWithAlpha(local5, Texture1.Sample(TexSampler, pixel.uv).a);
    // END GENERATED CODE
